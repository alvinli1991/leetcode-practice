...
public class HouseRobberIi {
    ...
    class Solution {
        ...
        public int rob(int[] nums) {
            ...
            return Math.max(robNotCircle(Arrays.copyOfRange(nums, 0, nums.length - 1))
                    , robNotCircle(Arrays.copyOfRange(nums, 1, nums.length)));
        }

        public int robNotCircle(int[] nums) {
            int max = 0;
